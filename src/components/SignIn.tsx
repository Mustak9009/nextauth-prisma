        ...
        <form action="POST" onSubmit={handleSubmit} autoComplete="off">
          <div className="card_top">
            ...
            <div className="input_box">
              ...
              <input
                type={`${isShow === EyeState.SHOW ? "text" : "password"}`}
                name="password"
                id="password"
              ...
              <div className="relative left-[92%] bottom-7 inline w-5 cursor-pointer">
                {isShow === EyeState.SHOW ? (
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 576 512"
                    onClick={() => setIsShow(EyeState.HIDE)}
                  >
                  ...
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 640 512"
                    onClick={() => setIsShow(EyeState.SHOW)}
                  >
              ...
              {errors.password && touched.password && (
                <p className="text-red-500 relative -top-4">
                  {errors.password}
                </p>
              )}
            </div>
          ...
          <div className="card_bottom">
            <div className="sign_with_google mb-2">
              <button
                type="button"
                className="btn w-full py-2 flex justify-center items-center gap-2"
